    ...
    const ce = [function(e) {
        ...
        function m() {
            ...
            if ("bullets" === e.type) {
                ...
                for (let s = 0; s < a; s += 1) e.renderBullet ? r += e.renderBullet.call(t, s, e.bulletClass) : r += `<${e.bulletElement} ${t.isElement?'part="bullet"':""} className="${e.bulletClass}"></${e.bulletElement}>`
            }
            "fraction" === e.type && (r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span className="${e.currentClass}"></span> / <span className="${e.totalClass}"></span>`), "progressbar" === e.type && (r = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span className="${e.progressbarFillClass}"></span>`), t.pagination.bullets = [], a.forEach((s => {
